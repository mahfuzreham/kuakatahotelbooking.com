...
use App\Http\Controllers\HotelManager\StayController as HotelManagerStayController;
...
Route::middleware('auth')->group(function(){
 ...
 Route::middleware('admin')->group(function(){
  ...
  Route::get('/admin/customers/{user}',[UserController::class,'customerShow'])->name('admin.customers.show');
 ...
 Route::middleware('role:hotel_manager')->group(function(){
  ...
  Route::get('/hotel-manager/bookings/{booking}',[HotelManagerBookingController::class,'show'])->name('hotel-manager.bookings.show');
  Route::get('/hotel-manager/properties/{property}/rooms',[HotelManagerRoomController::class,'index'])->name('hotel-manager.rooms.index');
  Route::post('/hotel-manager/properties/{property}/rooms',[HotelManagerRoomController::class,'store'])->name('hotel-manager.rooms.store');
  Route::post('/hotel-manager/bookings/{booking}/check-in',[HotelManagerStayController::class,'checkIn'])->name('hotel-manager.bookings.checkin');
  Route::post('/hotel-manager/bookings/{booking}/check-out',[HotelManagerStayController::class,'checkOut'])->name('hotel-manager.bookings.checkout');
 });
});