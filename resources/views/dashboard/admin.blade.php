...
<style>
.admin-shell{min-height:100vh;background:#f5f7fb;display:flex;font-family:Arial,sans-serif}.admin-sidebar{width:255px;background:#102a43;color:#fff;padding:28px 18px}.admin-sidebar h2{margin:0 0 26px}.admin-sidebar a{display:block;color:#d9e2ec;text-decoration:none;padding:11px 12px;border-radius:8px;margin:3px 0}.admin-sidebar a:hover{background:#243b53;color:#fff}.admin-sidebar b{float:right;background:#d64545;border-radius:20px;padding:2px 7px;color:#fff}.admin-logout-form{margin-top:18px}.admin-logout{width:100%;padding:11px 12px;border:1px solid #d64545;border-radius:8px;background:#d64545;color:#fff;font-weight:700;cursor:pointer}.admin-logout:hover{background:#b83232}.admin-main{flex:1;padding:38px;min-width:0}.eyebrow{color:#627d98;font-weight:700;font-size:12px;letter-spacing:1px}.admin-main h1{margin-top:0;color:#102a43}.admin-stats{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:16px;margin:24px 0}.admin-stats>div,.admin-card{background:#fff;border-radius:12px;padding:20px;box-shadow:0 2px 12px rgba(0,0,0,.05)}.admin-stats span,.admin-stats small{display:block;color:#627d98}.admin-stats strong{display:block;font-size:28px;color:#102a43;margin:8px 0}.admin-actions{display:flex;gap:12px;margin-bottom:22px;flex-wrap:wrap}.admin-actions a{background:#176b87;color:#fff;padding:12px 18px;border-radius:8px;text-decoration:none;font-weight:700}.section-head{display:flex;justify-content:space-between;align-items:center}.admin-table-wrap{overflow:auto}table{width:100%;border-collapse:collapse}th,td{text-align:left;padding:14px;border-bottom:1px solid #e9edf2}th{color:#627d98;font-size:12px}.trend-list{display:grid;gap:8px}.trend-row{display:flex;justify-content:space-between;padding:12px;background:#f7fafc;border-radius:8px}.mt-4{margin-top:22px}.status{background:#eef4ff;padding:5px 9px;border-radius:20px;font-size:12px}@media(max-width:800px){.admin-shell{display:block}.admin-sidebar{width:auto;display:flex;gap:5px;overflow:auto;padding:12px}.admin-sidebar h2{display:none}.admin-sidebar a{white-space:nowrap}.admin-logout-form{margin:0;flex:0 0 auto}.admin-logout{width:auto;white-space:nowrap}.admin-main{padding:20px}.admin-stats{grid-template-columns:repeat(2,1fr)}}@media(max-width:480px){.admin-stats{grid-template-columns:1fr}.admin-actions{flex-direction:column}}
</style>
@endsection
